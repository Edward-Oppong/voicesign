    ...
    <div style={{ display: 'flex', height: '100vh', backgroundColor: 'var(--primary-dark)', overflow: 'hidden', fontFamily: 'var(--font-body)' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            <p style={{ margin: 0, fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', color: 'var(--n4)', marginBottom: 4 }}>
              {activeTab === 'speech' ? 'Live Transcript' : 'Camera Translation'}
            </p>
            <h2 style={{ margin: 0, fontFamily: 'var(--font-display)', fontSize: 22, color: 'var(--primary-dark)' }}>
              {activeTab === 'speech' ? 'Speech → GSL Sign' : 'GSL Sign → English Text'}
            </h2>
          </div>
